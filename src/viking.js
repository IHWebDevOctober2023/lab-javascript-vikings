...
class War {
    ...
    vikingAttack() {
        ...
        // perform the attack
        const results = randomSaxon.receiveDamage(attackPoints);
    ...
    saxonAttack() {
        ...
        const attackPoints = randomSaxon.attack();
        // perform the attack
        const results = randomViking.receiveDamage(attackPoints);

        // if the Viking is dead, we remove it from the array
